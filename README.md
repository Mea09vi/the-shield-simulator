...
**v18.9.0 · 7-Domain + AI Staff**

| Version | สิ่งสำคัญ |
|---------|-----------|
| v18.9.0 | **SYNC-1 — ตารางประสานสอดคล้อง:** ตาราง *เวลา × หน้าที่การรบ* (๖ ด้าน × ๕ ห้วง สัมพัทธ์ H-hour) ใช้หาช่องว่างของแผนและจุดที่งานชนกัน · **ไม่ต้องกรอกเองทั้งตาราง** — ดึงจาก DP · NAI · CCIR · กำลังที่วางจริง · สถานะเรือ มาเติมให้ก่อน แล้วเติมของตัวเองเพิ่มได้ · ทุกรายการติดป้ายที่มา · ไฮไลต์ห้วงเวลาปัจจุบัน |
| v18.8.0 | **CCIR-1 — ข้อมูลข่าวสารสำคัญยิ่งของ ผบ.:** เดิมทั้งไฟล์มีคำว่า *CCIR* ๐ ครั้ง · ผบ. ประกาศล่วงหน้าว่าอะไรต้องรู้ทันที แล้วระบบเฝ้าให้ · **PIR** (ข้าศึก/สภาพแวดล้อม) ๔ ตัววัด + **FFIR** (กำลังฝ่ายเรา) ๔ ตัววัด · **ต่างจากจุดตกลงใจตรงที่เป็นการเฝ้ายืน** — เงื่อนไขคลายแล้วกลับมาใหม่จะเตือนอีก (DP ยิงครั้งเดียวจบ) |
...
- **Synchronization Matrix** (v18.9.0) — ตาราง เวลา × หน้าที่การรบ · เติมอัตโนมัติจากแผนที่มีอยู่
- **CCIR / PIR / FFIR** (v18.8.0) — เกณฑ์ที่ ผบ. ต้องรู้ทันที · เฝ้ายืน เตือนซ้ำได้เมื่อเงื่อนไขกลับมา
